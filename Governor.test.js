const { BN, constants, expectEvent, expectRevert, time } = require("@bininvest/coin-test-helpers");
const ethSigUtil = require("eth-sig-util");
const Wallet = require("ethereumjs-wallet").default;
const Enums = require("../helpers/enums");
const { TIP712Domain } = require("../helpers/tip712");
...
const Token = artifacts.require("FREXVotesMock");
...
contract("Governor", function (accounts) {
    ...
    const version = "1";
    const tokenName = "Freedom";
    const tokenSymbol = "FREX";
