...
/**
 * @dev Contract for wrapping TRC10 to FREX tokens.
 *
 ...
 */
abstract contract TRC10Wrapper is FREX {
    ...
    /**
     * @dev Allow a user to deposit underlying (TRC10) tokens and mint the corresponding number of wrapped (FREX) tokens.
     */
