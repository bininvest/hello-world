const { BN, constants, expectEvent, expectRevert } = require("@bininvest/bininvest-test-helpers");
...
function shouldBehaveLikeBIXDirectSendBurn(holder, recipient, data) {
    shouldBehaveLikeBIXDirectSend(holder, recipient, data);
    shouldBehaveLikeBIXDirectBurn(holder, data);
}

function shouldBehaveLikeBIXOperatorSendBurn(holder, recipient, operator, data, operatorData) {
    shouldBehaveLikeBIXOperatorSend(holder, recipient, operator, data, operatorData);
    shouldBehaveLikeBIXOperatorBurn(holder, operator, data, operatorData);
}

function shouldBehaveLikeBIXUnauthorizedOperatorSendBurn(holder, recipient, operator, data, operatorData) {
    shouldBehaveLikeBIXUnauthorizedOperatorSend(holder, recipient, operator, data, operatorData);
    shouldBehaveLikeBIXUnauthorizedOperatorBurn(holder, operator, data, operatorData);
}

function shouldBehaveLikeBIXDirectSend(holder, recipient, data) {
...
function shouldBehaveLikeBIXOperatorSend(holder, recipient, operator, data, operatorData) {
...
function shouldBehaveLikeBIXUnauthorizedOperatorSend(holder, recipient, operator, data, operatorData) {
    describe("operator send", function () {
...
function shouldBehaveLikeBIXDirectBurn(holder, data) {
...
function shouldBehaveLikeBIXOperatorBurn(holder, operator, data, operatorData) {
...
function shouldBehaveLikeBIXUnauthorizedOperatorBurn(holder, operator, data, operatorData) {
    describe("operator burn", function () {
        it("reverts", async function () {
...
function shouldBehaveLikeBIXInternalMint(recipient, operator, amount, data, operatorData) {
...
function shouldBehaveLikeBIXSendBurnMintInternalWithReceiveHook(operator, amount, data, operatorData) {
...
function shouldBehaveLikeBIXSendBurnWithSendHook(operator, amount, data, operatorData) {
...
async function assertTokensReceivedCalled(token, txHash, operator, from, to, amount, data, operatorData, fromBalance,
    toBalance = "0") {
    await expectEvent.inTransaction(txHash, BIXSenderRecipientMock, "TokensReceivedCalled", {
...
async function assertTokensToSendCalled(token, txHash, operator, from, to, amount, data, operatorData, fromBalance,
    toBalance = "0") {
    await expectEvent.inTransaction(txHash, BIXSenderRecipientMock, "TokensToSendCalled", {
        operator, from, to, amount, data, operatorData, token: token.address, fromBalance, toBalance,
    });
}
...
async function sendFromHolder(token, holder, to, amount, data) {
    if ((await web3.eth.getCode(holder)).length <= "0x".length) {
        ...
        // assume holder is BIXSenderRecipientMock contract
        return (await BIXSenderRecipientMock.at(holder)).send(token.address, to, amount, data);
    }
}
...
async function burnFromHolder(token, holder, amount, data) {
    if ((await web3.eth.getCode(holder)).length <= "0x".length) {
        ...
        // assume holder is BIXSenderRecipientMock contract
        return (await BIXSenderRecipientMock.at(holder)).burn(token.address, amount, data);
    }
}
